    ...
    return (
      <div>
        <div style={{ padding: 10, display: "flex", alignItems: "center" }}>
          ...
          />
          {usePriceFilter && (
            <Tooltip title="Кликните чтобы изменить диапазон" disableFocusListener>
              <Button
                variant="outlined"
          ...
          >
            <MenuItem value={"lh"}>Сортировка по цене: по возрастанию</MenuItem>
            <MenuItem value={"hl"}>Сортировка по цене: по убыванию</MenuItem>
          </Select>
        </div>
